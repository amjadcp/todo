...
export const SelectScrollUpButton = React.forwardRef((props, ref) => {
...
export const SelectScrollDownButton = React.forwardRef((props, ref) => {
  const { className, ...rest } = props;
  return (
...
export const SelectSeparator = React.forwardRef((props, ref) => {
  const { className, ...rest } = props;
  return (
